    ...
    <div class="container">
        <div class="col-md-12">
            <div class="card mb-4">
                ...
                <div class="card-body">
                    <a class ="btn btn-success" href="{{route('permission.create')}}">ایجاد دسترسی جدید </a>
                        ...
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                ...
                                <div class="modal-footer">
                                    ...
                                    <form action="{{route('destroy.job',[$per->id])}}" method="post">
                                        @csrf
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            $('#dataTable').DataTable({
                ...
                ajax: "{{ route('data.tables.getPermissions') }}",
