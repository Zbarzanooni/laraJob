@include('layouts.app')
    ...
    <div class="controller"  style="background-color: #e9e5e5">
        <div class="row " >
            <div class="col-md-6">
                <a href="{{route('create.employer')}}"><img src="{{asset('image/register-in-manamo-site-and-application.jpg')}}" class="" alt="" /></a>
            </div>
                         ...
                         <div class="card-body d-f justify-content-center">
                             <form action="{{route('store.seeker')}}" method="post">@csrf
                                 <div class="form-group p-2">
                                     <input type="text" class="form-control" name="name" placeholder="نام کاربری ">
                                 </div>
                                 @if($errors->has('name'))
                                 ...
                                 <div class="form-group d-flex justify-content-center m-2" style="background-color: #399d39">
                                     <button class="btn text-white "> ثبت نام </button>
                                 </div>
                             </form>
                         </div>
                     </div>
