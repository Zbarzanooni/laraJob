...
@section('content')
    ...
    <div class=" p-5">
        <form action="{{route('role.edit',$role)}}" method="post" enctype="multipart/form-data">@csrf
            ...
            <div class="form-group">
                ...
                <textarea  id="summernote" name="description" class="form-control summernote" placeholder="{{$role->description}}"></textarea>
            </div>
